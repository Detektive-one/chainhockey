...
class GameScene extends Phaser.Scene {
    ...
    update() {
        ...
        if (p1Input.active) {
            ...
            // Zero velocity so physics doesn't fight the drag position
            this.matter.body.setVelocity(this.striker1.body, { x: 0, y: 0 });
        }
        ...
        if (p2Input.active) {
            ...
            this.matter.body.setVelocity(this.striker2.body, { x: 0, y: 0 });
        }
